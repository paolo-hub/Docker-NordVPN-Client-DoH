...
4. You can verify the actual connection to Cloudflare and check for any DNS leaks using the script developed in the Mark GitHub project: [dnsleaktest](https://github.com/macvk/dnsleaktest](https://github.com/macvk/dnsleaktest)
